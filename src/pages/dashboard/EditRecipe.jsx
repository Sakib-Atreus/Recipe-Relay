...
const EditRecipe = () => {
  ...
  const handleCreateRecipe = async (e) => {
    ...
    const data = await axios.patch(`http://localhost:3000/recipes/${id}`, recipeData);
    if (data?.status === 200 && data.data?.insertedId) {
      Swal.fire(
        'Good job!',
        'Your recipe updated successfully',
        'success'
      );
      form.reset();
    }
  ...
  return (
    <div className="w-full px-16">
      <h1 className="text-4xl mb-8 text-center font-semibold">Update Recipe</h1>
